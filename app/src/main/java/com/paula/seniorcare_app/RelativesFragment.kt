 ...
 * Use the [FragmentRelatives.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentRelatives : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentRelatives.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentRelatives().apply {
